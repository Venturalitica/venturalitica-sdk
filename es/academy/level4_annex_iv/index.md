...
**Prerrequisito**: [Nivel 3 (El Auditor)](https://venturalitica.github.io/venturalitica-sdk/es/academy/level3_auditor/index.md)
...
1. Ve a la pestaña **"Generador Anexo IV"**.
1. Selecciona Proveedor: **Nube (Mistral)**, **Local (Ollama)**, o **Soberana (ALIA - Experimental)**.
1. Click en **"Generar Anexo IV"**.
...
1. **Planner**: Decide qué secciones del Anexo IV aplican a tu tipo de modelo específico.
1. **Writer**: Redacta "Sección 2.c: Arquitectura" usando el `summary()` de tu código Python real.
1. **Critic**: Revisa el borrador contra el estándar ISO 42001.
...
1. **LiveTrace**: Si tu precisión cae mañana, regenera el documento. Reflejará el estado *actual*, previniendo la "Deriva de Documentación".
1. **El Bucle Completo**: Has ido de Código -> Política (N1) -> Ops (N2) -> Evidencia (N3) -> Documento Legal (N4).
...
👉 **[Profundización: Integración MLOps](https://venturalitica.github.io/venturalitica-sdk/es/integrations/index.md)** 👉 **[Profundización: Bucle de Entrenamiento](https://venturalitica.github.io/venturalitica-sdk/es/training/index.md)**
