...
Consulta la [Guía de Redacción de Políticas](/guides/policy-authoring/) para la referencia completa del formato.
...
Consulta la [Referencia de Probes](/reference/probes/) para detalles sobre cada probe.
...
- **[Academy Nivel 1](/academy/level1-policy/)** -- Profundización en la redacción de políticas
- **[Column Binding](/guides/column-binding/)** -- Cómo los nombres abstractos se mapean a columnas
- **[Guía del Dashboard](/guides/dashboard/)** -- Recorrido detallado del Dashboard
