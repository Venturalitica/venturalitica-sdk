...
Acompaña al preprint en arXiv *Making AI Compliance Evidence Machine-Readable* ([Cilla Ugarte et al., 2026](https://arxiv.org/abs/2604.13767)).
...
- Runbook interno de smoke entre componentes: [`cross-component-smoke.md`](https://github.com/Venturalitica/venturalitica-sdk/blob/main/docs/development/cross-component-smoke.md)
