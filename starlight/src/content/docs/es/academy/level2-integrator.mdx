...
**Prerrequisito**: [Nivel 1 (El Ingeniero)](/venturalitica-sdk/academy/level1-policy/)
...
![Gráfico de Evidencia](/venturalitica-sdk/images/dashboard_overview.png)
...
- **[Referencia de API](/venturalitica-sdk/reference/api/)** -- Firmas de `enforce()` y `monitor()`
- **[Autoría de Políticas](/venturalitica-sdk/guides/policy-authoring/)** -- Cómo escribir políticas OSCAL
- **[Referencia de Probes](/venturalitica-sdk/reference/probes/)** -- Qué captura `monitor()` automáticamente
- **[Column Binding](/venturalitica-sdk/guides/column-binding/)** -- Cómo funciona `gender="Attribute9"`

**[Siguiente: Nivel 3 (El Auditor)](/venturalitica-sdk/academy/level3-auditor/)**
