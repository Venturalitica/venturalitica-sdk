...
| **[Nivel 1](/venturalitica-sdk/academy/level1-policy/)** | **Ingeniero** | **Implementar Controles** para Riesgos. |
| **[Nivel 2](/venturalitica-sdk/academy/level2-integrator/)** | **Integrador** | **Viz & MLOps**: "Cumplimiento como Metadata". |
| **[Nivel 3](/venturalitica-sdk/academy/level3-auditor/)** | **Auditor** | Prueba: "Confía en la Caja de Cristal". |
| **[Nivel 4](/venturalitica-sdk/academy/level4-annex-iv/)** | **Arquitecto** | Docs GenAI: "Anexo IV". |
...
| :--- | :--- | :--- |
| **[Nivel 1](/venturalitica-sdk/academy/level1-policy/)** | El Ingeniero | Aprende a implementar **Controles** que mitigan Riesgos identificados. **Detecta y Bloquea** modelos no conformes. |
| **[Nivel 2](/venturalitica-sdk/academy/level2-integrator/)** | El Integrador | Registra resultados en herramientas MLOps y verifica resultados visualmente en el **Dashboard**. |
| **[Nivel 3](/venturalitica-sdk/academy/level3-auditor/)** | El Auditor | Aprende a realizar una auditoría de "Caja de Cristal" en el modelo de préstamos y genera pruebas criptográficas. |
| **[Nivel 4](/venturalitica-sdk/academy/level4-annex-iv/)** | El Arquitecto | El Nivel Jefe. Entrena un modelo financiero de alto riesgo y genera la masiva Documentación Técnica requerida por la EU AI Act. |
