...
**Prerrequisito**: [De Cero a Pro (Índice)](/academy/)
...
En el inicio rápido [De Cero a Pro](/academy/), `vl.quickstart('loan')` FALLÓ:
...
| :--- | :--- | :--- |
| `metric_key` | Qué métrica calcular (ver [Referencia de Métricas](/reference/metrics/)) | `disparate_impact`, `class_imbalance`, `accuracy_score` |
...
| `input:dimension` | Atributo protegido por el cual segmentar | `gender`, `age` (resuelto via [Column Binding](/guides/column-binding/)) |
...
Consulta [Column Binding](/guides/column-binding/) para ver el algoritmo completo de resolución.
...
**[Ir al Nivel 2: El Integrador (MLOps)](/academy/level2-integrator/)**
