...
**Prerrequisito**: [Nivel 3 (El Auditor)](/academy/level3-auditor/)
...
4.  Haz click en **"Generar Anexo IV"**.
    ...
    ![Generador Anexo IV](/images/annex_iv_generator.png)
...
- **[Ciclo de Vida Completo](/full-lifecycle/)** -- El flujo completo en una sola página para copiar y pegar
- **[Guía del Dashboard](/guides/dashboard/)** -- Tutorial detallado del Dashboard y la Fase 4
- **[Referencia de Métricas](/reference/metrics/)** -- Todas las 35+ métricas disponibles para políticas
- **[Creación de Políticas](/guides/policy-authoring/)** -- Escribe políticas OSCAL personalizadas
