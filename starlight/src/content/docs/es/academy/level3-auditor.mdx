...
**Prerrequisito**: [Nivel 2 (El Integrador)](/venturalitica-sdk/academy/level2-integrator/)
...
- **[Referencia de Probes](/venturalitica-sdk/reference/probes/)** -- Detalles sobre los 7 probes de evidencia
- **[Guía del Dashboard](/venturalitica-sdk/guides/dashboard/)** -- Recorrido completo de las fases del Dashboard
- **[Ciclo de Vida Completo](/venturalitica-sdk/full-lifecycle/)** -- Guía de extremo a extremo en una sola página

**[Ir al Nivel 4: El Arquitecto](/venturalitica-sdk/academy/level4-annex-iv/)**
