...
> El inicio rápido de Venturalítica es **totalmente local**. El ejemplo
> a continuación usa una política de juguete incluida; en producción,
> edita tu propio `assessment_plan.oscal.yaml` (consulta la [Guía de
...
- **[Referencia de API](/venturalitica-sdk/es/reference/api/)** -- Documentación completa de funciones
- **[Autoría de Políticas](/venturalitica-sdk/es/guides/policy-authoring/)** -- Cree sus propias reglas en OSCAL
- **[Referencia de Métricas](/venturalitica-sdk/es/reference/metrics/)** -- Listado de las 35+ métricas disponibles
- **[Academia Venturalítica](/venturalitica-sdk/es/academy/index/)** -- Ruta de aprendizaje para expertos en gobernanza
...
- **[Referencia de API](/venturalitica-sdk/reference/api/)** -- Firmas completas de `enforce()` y `monitor()`
- **[Autoría de Políticas](/venturalitica-sdk/guides/policy-authoring/)** -- Escribe tus propias políticas OSCAL
- **[Ciclo de Vida Completo](/venturalitica-sdk/full-lifecycle/)** -- De cero al Anexo IV en una sola página
- **[Academia: Nivel 1](/venturalitica-sdk/academy/level1-policy/)** -- Profundización en controles y el Handshake
- **[Dashboard](/venturalitica-sdk/guides/dashboard/)** -- Guía completa de la Caja de Cristal
