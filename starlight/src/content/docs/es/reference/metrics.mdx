...
Para tareas de clasificación multiclase. Consulta [Equidad Multiclase](/reference/multiclass-fairness/) para uso detallado.
...
Consulta la [Guía de Autoría de Políticas](/guides/policy-authoring/) para la referencia completa del formato OSCAL.
