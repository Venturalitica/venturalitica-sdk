...
- **[Referencia de Métricas](/reference/metrics/)** -- Las 35+ métricas incluyendo equidad binaria, privacidad y rendimiento
- **[Redacción de Políticas](/guides/policy-authoring/)** -- Cómo usar registry keys en controles OSCAL
- **[Vinculación de Columnas](/guides/column-binding/)** -- Cómo `dimension`, `target`, `prediction` se mapean a columnas
