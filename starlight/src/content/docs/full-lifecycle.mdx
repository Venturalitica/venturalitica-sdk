...
:::tip[Optional extras]
Need fairness metrics? `pip install "venturalitica[metrics]"`. See all extras on the [Introduction](/venturalitica-sdk/) page.
:::
...
See [Policy Authoring Guide](/venturalitica-sdk/guides/policy-authoring/) for the full format reference.
...
See [Probes Reference](/venturalitica-sdk/reference/probes/) for details on each probe.
...
- **[Academy Level 1](/venturalitica-sdk/academy/level1-policy/)** -- Deep dive into policy writing
- **[Column Binding](/venturalitica-sdk/guides/column-binding/)** -- How abstract names map to columns
- **[Dashboard Guide](/venturalitica-sdk/guides/dashboard/)** -- Detailed Dashboard walkthrough
