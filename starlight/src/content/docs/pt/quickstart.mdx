...
- **[Referência da API](/pt/reference/api/)** -- Documentação completa de funções
- **[Autoria de Políticas](/pt/guides/policy-authoring/)** -- Crie as suas próprias regras em OSCAL
- **[Referência de Métricas](/pt/reference/metrics/)** -- Lista das 35+ métricas disponíveis
- **[Academia Venturalítica](/pt/academy/index/)** -- Percurso de aprendizagem para especialistas em governação
