...
![Dashboard Home — AI Assurance Evidence Collection](/venturalitica-sdk/images/dashboard_overview.png)
...
![Phase 1 — System Identity Editor](/venturalitica-sdk/images/phase1_system_identity.png)
...
:::tip
The Policy Editor generates `assessment-plan` format, which is the canonical OSCAL format used throughout the SDK. See [Policy Authoring Guide](/venturalitica-sdk/guides/policy-authoring/) for the manual YAML format.
:::

![Phase 2 — Risk Policy Editor](/venturalitica-sdk/images/phase2_risk_policy.png)
...
![Phase 3 — Verify & Evaluate](/venturalitica-sdk/images/phase3_verify_evaluate.png)
...
![Phase 4 — Annex IV Generator](/venturalitica-sdk/images/annex_iv_generator.png)
