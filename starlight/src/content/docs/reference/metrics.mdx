...
For multi-class classification tasks. See [Multiclass Fairness](/reference/multiclass-fairness/) for detailed usage.
...
See [Policy Authoring Guide](/guides/policy-authoring/) for the complete OSCAL format reference.
