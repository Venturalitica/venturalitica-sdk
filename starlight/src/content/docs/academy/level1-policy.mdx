...
**Prerequisite**: [Zero to Pro (Academy Index)](/academy/)
...
In the [Zero to Pro](/academy/) quickstart, `vl.quickstart('loan')` FAILED:
...
| :--- | :--- | :--- |
| `metric_key` | Which metric to compute (from [Metrics Reference](/reference/metrics/)) | `disparate_impact`, `class_imbalance`, `accuracy_score` |
...
| `input:dimension` | Protected attribute to slice by | `gender`, `age` (resolved via [Column Binding](/guides/column-binding/)) |
...
See [Column Binding](/guides/column-binding/) for the full resolution algorithm.
...
**[Go to Level 2: The Integrator (MLOps)](/academy/level2-integrator/)**
