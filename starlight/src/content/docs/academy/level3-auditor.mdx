...
**Prerequisite**: [Level 2 (The Integrator)](/venturalitica-sdk/academy/level2-integrator/)
...
- **[Probes Reference](/venturalitica-sdk/reference/probes/)** -- Details on all 7 evidence probes
- **[Dashboard Guide](/venturalitica-sdk/guides/dashboard/)** -- Full walkthrough of the Dashboard phases
- **[Full Lifecycle](/venturalitica-sdk/full-lifecycle/)** -- End-to-end guide in one page

**[Go to Level 4: The Architect](/venturalitica-sdk/academy/level4-annex-iv/)**
