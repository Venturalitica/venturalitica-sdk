...
**Prerequisite**: [Level 3 (The Auditor)](/academy/level3-auditor/)
...
4.  Click **"Generate Annex IV"**.
    ...
    ![Annex IV Generator](/images/annex_iv_generator.png)
...
- **[Full Lifecycle](/full-lifecycle/)** -- The entire flow in one copy-paste page
- **[Dashboard Guide](/guides/dashboard/)** -- Detailed Dashboard and Phase 4 walkthrough
- **[Metrics Reference](/reference/metrics/)** -- All 35+ metrics available for policies
- **[Policy Authoring](/guides/policy-authoring/)** -- Write custom OSCAL policies
