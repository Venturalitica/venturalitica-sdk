...
Every time you train a model using `vl.wrap()` or `vl.monitor()`, Venturalítica automatically snapshots your assurance policy (`model_policy.yaml`) and uploads it to your active tracking server.
...
with mlflow.start_run():
    ...
    # 3. Transparent Wrapping (The Assurance Layer)
