...
El **Panel de Cumplimiento de Venturalítica** es tu centro de control local para la Assurance de IA. A diferencia de las herramientas de cumplimiento de "Caja Negra" que operan a puerta cerrada, Venturalítica proporciona una experiencia de **Caja de Cristal**: expone la evidencia técnica exacta que tu sistema está produciendo y la mapea directamente a las obligaciones regulatorias.
...
![Mapa Regulatorio (Art 9-11)](../assets/images/compliance_map_top.png) # Note: adjusted path
...
#### 2. [Artículo 10: Assurance de Datos](https://artificialintelligenceact.eu/es/article/10/)
...
![Mapa Regulatorio (Art 12-15)](../assets/images/compliance_map_bottom.png) # Note: adjusted path
...
2.  **Limpiar Datos** (Art 10)
3.  **Documentarlo** (Art 11)
4.  **Registrarlo** (Art 12)
5.  **Explicarlo** (Art 13)
6.  **Controlarlo** (Art 14)
7.  **Asegurarlo** (Art 15)
