...
Cada vez que entrenas un modelo usando `vl.wrap()` o `vl.monitor()`, Venturalítica automáticamente toma una instantánea de tu política de assurance (`model_policy.yaml`) y la sube a tu servidor de seguimiento activo.
...
with mlflow.start_run():
    ...
    # 3. Envoltura Transparente (La Capa de Assurance)
